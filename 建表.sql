...
from Send
	 ...
	 Business
	 on
	 send.Bno = Business.Bno
	 join 
	 Customer
	 on
	 Send.Cno = Customer.Cno;
...
insert 
into Customer(Cno,Cname,Csex,Ctel,Cadds,Ccard)
values ('1001','周后金','男','1563464','江西省南昌市','6483564674643');

insert 
into Customer(Cno,Cname,Csex,Ctel,Cadds,Ccard)
values ('1002','李佛','男','1896464','美利坚合众国','8943165464416');

insert 
into Customer(Cno,Cname,Csex,Ctel,Cadds,Ccard)
values ('1003','白莲','女','1523684','湖北省孝感市','7853564874643');

insert 
into business(Bno,Bname,Btel,Badds)
values ('2001','三只河马','6546541','陕西省西安市'),
	   ('2002','山鸡','2643548','北京市'),
	   ('2003','森码','3168578','内蒙古自治区');
	   
insert 
into Staff(Sno,Sname,Ssex,Stel,Scard)
values ('3001','马印九','男','5464674','674641654647'),
	   ('3002','李老八','男','5863674','674616824686'),
	   ('3003','鞠魔战','男','6824674','924566654646');
	   
insert 
into Goods (Gno,Gname,Gtype,Gweight,Gprice)
...
insert 
into Send (Seno,Bno,Sno,Cno,sitime,sotime,setype)
