...
CREATE TABLE `订单详情表`  (
  `订单详情ID` int NOT NULL AUTO_INCREMENT,
  `关联订单ID` int NOT NULL,
  `商品ID` int NOT NULL,
  `购买数量` int NOT NULL,
...
CREATE TABLE `发货记录表`  (
  `发货ID` int NOT NULL AUTO_INCREMENT,
  `关联订单ID` int NOT NULL,
...
CREATE TABLE `退货表`  (
  `退货ID` int NOT NULL AUTO_INCREMENT,
  `关联订单ID` int NOT NULL,
  `退货产品ID` int NOT NULL,
...
CREATE TABLE `物流状态表`  (
  `状态ID` int NOT NULL AUTO_INCREMENT,
  `关联订单ID` int NOT NULL,
...
SELECT `订单表`.`订单ID`, `客户表`.`客户名称`, `客户表`.`联系方式`, `订单详情表`.`商品ID`, `订单详情表`.`购买数量`, `订单详情表`.`单价`, `发货记录表`.`发货日期`
FROM `订单表`
